!function (A, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.VueWeui = t() : A.VueWeui = t()
}(this, function () {
    return function (A) {
        function t(e) {
            if (i[e])return i[e].exports;
            var o = i[e] = {exports: {}, id: e, loaded: !1};
            return A[e].call(o.exports, o, o.exports, t), o.loaded = !0, o.exports
        }

        var i = {};
        return t.m = A, t.c = i, t.p = "", t(0)
    }([function (A, t, i) {
        "use strict";
        function e(A) {
        ...
        var o = i(37), a = e(o), n = i(49), s = e(n), r = i(52), l = e(r), c = i(57), g = e(c), w = i(60), p = e(w), f = i(65), d = e(f), u = i(70), M = e(u), y = i(75), I = e(y), b = i(80), B = e(b), m = i(43), _ = e(m), x = {
            actionSheet: a["default"],
            select: s["default"],
            dialog: l["default"],
            icon: g["default"],
            msg: p["default"],
        ...
        i(38), A.exports = i(42), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(48)
    }, function (A, t, i) {
        var e = i(39);
        ...
        t = A.exports = i(40)(), t.push([A.id, '.weui_actionsheet{position:fixed;left:0;bottom:0;-webkit-transform:translateY(100%);-ms-transform:translateY(100%);transform:translateY(100%);-webkit-backface-visibility:hidden;backface-visibility:hidden;z-index:2;width:100%;background-color:#efeff4;-webkit-transition:-webkit-transform .3s;transition:-webkit-transform .3s;transition:transform .3s;transition:transform .3s,-webkit-transform .3s}.weui_actionsheet_menu{background-color:#fff}.weui_actionsheet_action{margin-top:6px;background-color:#fff}.weui_actionsheet_cell{position:relative;padding:10px 0;text-align:center;font-size:18px}.weui_actionsheet_cell:before{content:" ";position:absolute;left:0;top:0;width:100%;height:1px;border-top:1px solid #d9d9d9;color:#d9d9d9;-webkit-transform-origin:0 0;-ms-transform-origin:0 0;transform-origin:0 0;-webkit-transform:scaleY(.5);-ms-transform:scaleY(.5);transform:scaleY(.5)}.weui_actionsheet_cell:active{background-color:#ececec}.weui_actionsheet_cell:first-child:before{display:none}.weui_actionsheet_toggle{-webkit-transform:translate(0);-ms-transform:translate(0);transform:translate(0)}', ""])
    }, function (A, t) {
        A.exports = function () {
            var A = [];
            return A.toString = function () {
                ...
                for (o = 0; o < t.length; o++) {
                    var n = t[o];
                    "number" == typeof n[0] && e[n[0]] || (i && !n[2] ? n[2] = i : i && (n[2] = "(" + n[2] + ") and (" + i + ")"), A.push(n))
                }
            }, A
        }
    }, function (A, t, i) {
        function e(A, t) {
            for (var i = 0; i < A.length; i++) {
                ...
                if (o) {
                    ...
                    for (; a < e.parts.length; a++)o.parts.push(l(e.parts[a], t))
                } else {
                    for (var n = [], a = 0; a < e.parts.length; a++)n.push(l(e.parts[a], t));
                    p[e.id] = {id: e.id, refs: 1, parts: n}
                }
            }
        }

        function o(A) {
            for (var t = [], i = {}, e = 0; e < A.length; e++) {
                var o = A[e], a = o[0], n = o[1], s = o[2], r = o[3], l = {css: n, media: s, sourceMap: r};
        ...
        function a(A, t) {
            var i = u(), e = I[I.length - 1];
            if ("top" === A.insertAt)e ? e.nextSibling ? i.insertBefore(t, e.nextSibling) : i.appendChild(t) : i.insertBefore(t, i.firstChild), I.push(t); else {
        ...
        function s(A) {
            ...
            return t.type = "text/css", a(A, t), t
        }

        function r(A) {
            var t = document.createElement("link");
            return t.rel = "stylesheet", a(A, t), t
        }
        ...
        function l(A, t) {
            ...
            if (t.singleton) {
                var a = y++;
                i = M || (M = s(t)), e = c.bind(null, i, a, !1), o = c.bind(null, i, a, !0)
            } else A.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = r(t), e = w.bind(null, i), o = function () {
                n(i), i.href && URL.revokeObjectURL(i.href)
            }) : (i = s(t), e = g.bind(null, i), o = function () {
                n(i)
            });
        ...
        function c(A, t, i, e) {
            var o = i ? "" : e.css;
            if (A.styleSheet)A.styleSheet.cssText = b(t, o); else {
                var a = document.createTextNode(o), n = A.childNodes;
                n[t] && A.removeChild(n[t]), n.length ? A.insertBefore(a, n[t]) : A.appendChild(a)
            }
        }
        ...
        function g(A, t) {
            ...
            t.sourceMap;
            if (e && A.setAttribute("media", e), A.styleSheet)A.styleSheet.cssText = i; else {
        ...
        function w(A, t) {
            var i = t.css, e = (t.media, t.sourceMap);
            e && (i += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(e)))) + " */");
            var o = new Blob([i], {type: "text/css"}), a = A.href;
            A.href = URL.createObjectURL(o), a && URL.revokeObjectURL(a)
        }
        ...
        var b = function () {
            var A = [];
            return function (t, i) {
                return A[t] = i, A.filter(Boolean).join("\n")
            }
        }()
    }, function (A, t, i) {
        "use strict";
        ...
        i(44), A.exports = i(46), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(47)
    }, function (A, t, i) {
        var e = i(45);
        "string" == typeof e && (e = [[A.id, e, ""]]);
        i(41)(e, {});
        ...
        t = A.exports = i(40)(), t.push([A.id, ".weui_mask{background:rgba(0,0,0,.6)}.weui_mask,.weui_mask_transition,.weui_mask_transparent{position:fixed;z-index:1;width:100%;height:100%;top:0;left:0}.weui_mask_transition{display:none;background:transparent;-webkit-transition:background .3s;transition:background .3s}.weui_fade_toggle{background:rgba(0,0,0,.6)}", ""])
    }, function (A, t) {
        "use strict";
        ...
        A.exports = "<div class=weui_mask_transition :class={weui_fade_toggle:isShow} id=mask v-show=isShow v-on:click=close()></div>"
    }, function (A, t) {
        A.exports = "<div id=actionSheet_wrap><mask :is-show.sync=isShow></mask><div class=weui_actionsheet :class={weui_actionsheet_toggle:isShow} id=weui_actionsheet><div class=weui_actionsheet_menu><div class=weui_actionsheet_cell v-on:click=close()>示例菜单</div><div class=weui_actionsheet_cell v-on:click=close()>示例菜单</div><div class=weui_actionsheet_cell v-on:click=close()>示例菜单</div><div class=weui_actionsheet_cell>示例菜单(我没有关闭功能)</div></div><div class=weui_actionsheet_action><div class=weui_actionsheet_cell id=actionsheet_cancel v-on:click=close()>取消</div></div></div></div>"
    }, function (A, t, i) {
        A.exports = i(50), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(51)
    }, function (A, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = {
            props: {
        ...
        A.exports = '<select class=weui_select v-model=selected><option v-for="(index, option) in options" :value="index + 1">{{option}}</select>'
    }, function (A, t, i) {
        i(53), A.exports = i(55), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(56)
    }, function (A, t, i) {
        var e = i(54);
        "string" == typeof e && (e = [[A.id, e, ""]]);
        i(41)(e, {});
        ...
        t = A.exports = i(40)(), t.push([A.id, '.weui_btn.weui_btn_mini{line-height:1.9;font-size:14px;padding:0 .75em;display:inline-block}button.weui_btn,input.weui_btn{width:100%;border-width:0;outline:0;-webkit-appearance:none}button.weui_btn:focus,input.weui_btn:focus{outline:0}button.weui_btn_inline,button.weui_btn_mini,input.weui_btn_inline,input.weui_btn_mini{width:auto}.weui_btn+.weui_btn{margin-top:15px}.weui_btn.weui_btn_inline+.weui_btn.weui_btn_inline{margin-top:auto;margin-left:15px}.weui_btn_area{margin:1.17647059em 15px .3em}.weui_btn_area.weui_btn_area_inline{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}.weui_btn_area.weui_btn_area_inline .weui_btn{margin-top:auto;margin-right:15px;width:100%;-webkit-box-flex:1;-webkit-flex:1;-ms-flex:1;flex:1}.weui_btn_area.weui_btn_area_inline .weui_btn:last-child{margin-right:0}.weui_btn{position:relative;display:block;margin-left:auto;margin-right:auto;padding-left:14px;padding-right:14px;box-sizing:border-box;font-size:18px;text-align:center;text-decoration:none;color:#fff;line-height:2.33333333;border-radius:5px;-webkit-tap-highlight-color:rgba(0,0,0,0);overflow:hidden}.weui_btn:after{content:" ";width:200%;height:200%;position:absolute;top:0;left:0;border:1px solid rgba(0,0,0,.2);-webkit-transform:scale(.5);-ms-transform:scale(.5);transform:scale(.5);-webkit-transform-origin:0 0;-ms-transform-origin:0 0;transform-origin:0 0;box-sizing:border-box;border-radius:10px}.weui_btn.weui_btn_inline{display:inline-block}.weui_btn_default{background-color:#f7f7f7;color:#454545}.weui_btn_default:not(.weui_btn_disabled):visited{color:#454545}.weui_btn_default:not(.weui_btn_disabled):active{color:#a1a1a1;background-color:#dedede}.weui_btn_primary{background-color:#04be02}.weui_btn_primary:not(.weui_btn_disabled):visited{color:#fff}.weui_btn_primary:not(.weui_btn_disabled):active{color:hsla(0,0%,100%,.4);background-color:#039702}.weui_btn_warn{background-color:#ef4f4f}.weui_btn_warn:not(.weui_btn_disabled):visited{color:#fff}.weui_btn_warn:not(.weui_btn_disabled):active{color:hsla(0,0%,100%,.4);background-color:#c13e3e}.weui_btn_disabled{color:hsla(0,0%,100%,.6)}.weui_btn_disabled.weui_btn_default{color:#c9c9c9}.weui_btn_plain_primary{color:#04be02;border:1px solid #04be02}button.weui_btn_plain_primary,input.weui_btn_plain_primary{border-width:1px;background-color:transparent}.weui_btn_plain_primary:active{border-color:#039702}.weui_btn_plain_primary:after{border-width:0}.weui_btn_plain_default{color:#5a5a5a;border:1px solid #5a5a5a}button.weui_btn_plain_default,input.weui_btn_plain_default{border-width:1px;background-color:transparent}.weui_btn_plain_default:after{border-width:0}.weui_msg{padding-top:36px;text-align:center}.weui_msg .weui_icon_area{margin-bottom:30px}.weui_msg .weui_text_area{margin-bottom:25px;padding:0 20px}.weui_msg .weui_msg_title{margin-bottom:5px;font-weight:400;font-size:20px}.weui_msg .weui_msg_desc{font-size:14px;color:#888}.weui_msg .weui_opr_area{margin-bottom:25px}.weui_msg .weui_extra_area{margin-bottom:15px;font-size:14px;color:#888}.weui_msg .weui_extra_area a{color:#61749b}@media screen and (min-height:438px){.weui_extra_area{position:fixed;left:0;bottom:0;width:100%;text-align:center}}', ""])
    }, function (A, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = {name: "Msg", props: {}}
    }, function (A, t) {
        A.exports = '<div class=weui_msg><div class=weui_icon_area><i class="weui_icon_success weui_icon_msg"></i></div><div class=weui_text_area><h2 class=weui_msg_title>操作成功</h2><p class=weui_msg_desc>内容详情，可根据实际需要安排</p></div><div class=weui_opr_area><p class=weui_btn_area><a href=javascript:; class="weui_btn weui_btn_primary">确定</a> <a href=javascript:; class="weui_btn weui_btn_default">取消</a></p></div><div class=weui_extra_area><a href="">查看详情</a></div></div>'
    }, function (A, t, i) {
        i(66), A.exports = i(68), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(69)
    }, function (A, t, i) {
        var e = i(67);
        "string" == typeof e && (e = [[A.id, e, ""]]);
        i(41)(e, {});
        ...
        t = A.exports = i(40)(), t.push([A.id, ".weui_toptips{display:block}.weui_toptips.weui_success{background-color:#039702}", ""])
    }, function (A, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = {
            name: "Tooltips",
            ...
            watch: {
                text: function (A) {
                    var t = this;
                    this._timeout && clearTimeout(this._timeout), A && this.duration && (this._timeout = setTimeout(function () {
                        return t.text = ""
                    }, this.duration))
                }
            }
        ...
        A.exports = "<div v-show=text :class=\"{\n    'weui_toptips': true,\n    'weui_warn': (type == 'warn'),\n    'weui_success': (type == 'success')\n  }\">{{text}}</div>"
    }, function (A, t, i) {
        i(71), A.exports = i(73), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(74)
    }, function (A, t, i) {
        var e = i(72);
        "string" == typeof e && (e = [[A.id, e, ""]]);
        i(41)(e, {});
        ...
        t = A.exports = i(40)(), t.push([A.id, ".weui_progress{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center}.weui_progress_bar{background-color:#ebebeb;height:3px;-webkit-box-flex:1;-webkit-flex:1;-ms-flex:1;flex:1}.weui_progress_inner_bar{width:0;height:100%;background-color:#09bb07}.weui_progress_opr{display:block;margin-left:15px;font-size:0}", ""])
    }, function (A, t, i) {
        "use strict";
        function e(A) {
            return A && A.__esModule ? A : {"default": A}
        ...
        t["default"] = {
            name: "Progress",
            props: {size: {"default": 0}, showCloseBtn: {type: Boolean, required: !1, "default": !0}},
            data: function () {
                return {show: !0}
            },
            methods: {
                dispatch: function (A, t) {
                    this.$dispatch(t), this.show = !1
                }
            }
        }
    }, function (A, t) {
        A.exports = "<div v-if=show class=weui_progress><div class=weui_progress_bar><div class=weui_progress_inner_bar :style=\"{ width: size + '%' }\"></div></div><a v-if=showCloseBtn href=javascript:; class=weui_progress_opr @click=\"dispatch('on-progress-cancel')\"><i class=weui_icon_cancel></i></a></div>"
    }, function (A, t, i) {
        i(76), A.exports = i(78), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(79)
    }, function (A, t, i) {
        var e = i(77);
        "string" == typeof e && (e = [[A.id, e, ""]]);
        i(41)(e, {});
        ...
        t["default"] = {
            name: "Toast",
            props: {
                show: {type: Boolean, required: !0, "default": !1, twoWay: !0},
                type: {type: String},
                duration: {type: Number, "default": 3e3}
            },
            watch: {
        ...
        A.exports = "<div v-show=show><div class=weui_mask_transparent></div><div class=weui_toast><i class=weui_icon_toast></i><p class=weui_toast_content><slot>已完成</slot></p></div></div>"
    }, function (A, t, i) {
        i(81), A.exports = i(83), A.exports.__esModule && (A.exports = A.exports["default"]), ("function" == typeof A.exports ? A.exports.options : A.exports).template = i(84)
    }, function (A, t, i) {
        var e = i(82);
        "string" == typeof e && (e = [[A.id, e, ""]]);
        i(41)(e, {});
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = {name: "Loading"}
    }, function (A, t) {
        A.exports = '<div class=weui_loading_toast><div class=weui_mask_transparent></div><div class=weui_toast><div class=weui_loading><div v-for="n in 12" class=weui_loading_leaf :class="\'weui_loading_leaf_\' + n"></div></div><p class=weui_toast_content>数据加载中</p></div></div>'
    }])
});