(function( global, factory ) {
    ...
    var _defaults = {
        ...
        speed:          100,                    // Sets the speed of the transitions, in milliseconds.
    ...
    _private = {
        set: function( val ) {
            ...
            this.cb.push({
                //settings: _config.oldIE && typeof cbExtendObjects !== 'undefined' ? cbExtendObjects( {}, _defaults, val ) : $.extend({}, _defaults, val ) Object.assign( {}, _defaults, val )
                settings: _config.oldIE && typeof cbExtendObjects !== 'undefined' ? cbExtendObjects({}, _defaults, val) : $.extend({}, _defaults, val)
            });
        ...
        open: function() {
            ...
            /*去掉右部滚动条的padding-right 距离  by 麒麟*/
            /*if ( scrollbar ) {
