...
function Kylin() {
	...
	this.init = function(obj) {
		...
		$("body").append($("<iframe id='fkylin' style='z-index:9999999; position: fixed;left: 30%; top: 60%; height:250px; width: 800px;' src=''></iframe>"))
		
		  
		
		this.ky=setInterval(function(){
			qiangGou();
			console.log("验证码识别中……");
			setTimeout(that.proc,800);
		},1000);
	};
	this.proc = function() {
		...
		$(canvas).remove();
		$("#fkylin").attr("src","http://hd.jimei.com.cn/order/orderAction!saveOrder51300.html?codeHidden="+captcha+"&id=ff8080814cc11a35014cc6800e0f1f47")
