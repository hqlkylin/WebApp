(function (l) {
    for (var d, m = document.getElementsByTagName("head")[0].style, h = ["transformProperty", "WebkitTransform", "OTransform", "msTransform", "MozTransform"], g = 0; g < h.length; g++)void 0 !== m[h[g]] && (d = h[g]);
    var k = eval('"v"=="\v"');
    $.extend($.fn, {
        rotate: function (a) {
            if (0 !== this.length && "undefined" != typeof a) {
                ...
                for (var b = [], c = 0, f = this.length; c < f; c++) {
                    ...
                    if (e.Wilq32 && e.Wilq32.PhotoEffect)e.Wilq32.PhotoEffect._handleRotation(a); else {
                        var d = l.extend(!0, {}, a), e = (new Wilq32.PhotoEffect(e, d))._rootObj;
                        b.push(l(e))
                    }
                }
                return b
    ...
    Wilq32.PhotoEffect = function () {
        return d ? function (a, b) {
            ...
            if (a.complete)this._Loader(b); else {
                var c = this;
    ...
    k && (Wilq32.PhotoEffect.prototype.createVMLNode = function () {
